...
return [
    'site_title' => env('M1PP_SITE_TITLE', 'M1PPosu - [Beta]'),
    ...
    'private_server' => [
        ...
        'backend' => env('M1PP_PRIVATE_SERVER_BACKEND', 'bancho-py-ex'),
    ...
    'contact_email' => env('M1PP_CONTACT_EMAIL', 'support@m1pposu.local'),

    'community' => [
        'discord_url' => env('M1PP_DISCORD_URL', 'https://discord.gg/jTcgGNFj9g'),
    ],
